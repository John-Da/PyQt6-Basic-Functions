...
class Book:
    ...
    def print_book_info(self):
        print(f'{self.title} by {self.author} has discounted price as {self.get_discount_price(discount_precent):.2f} Baht')
...
print(f"Is {books[0].title} expensive? {Book.is_expensive(books[0].get_discount_price(10))}")
print(f"Is {books[2].title} expensive? {Book.is_expensive(books[2].get_discount_price(10))}")
